...
namespace ISfM
{
    ...
    public:
        struct Correspondence
        {
            ...
            Correspondence(const int image_id, int point2D_idx)
         ...
         */
        int NumObservationsForImage(int image_id) const;
         ...
         */
        int NumCorrespondencesForImage(int image_id) const;
         ...
         */
        int NumCorrespondencesBetweenImages(const int image_id1, const int image_id2) const;
         ...
         */
        void AddImage(const int image_id, const size_t num_points2D);
         ...
         */
        void AddCorrespondences(const int image_id1,
                                const int image_id2,
        ...
        const std::vector<typename SceneGraph::Correspondence> FindCorrespondences(
            const int image_id, const int point2D_idx) const;
        ...
        std::vector<cv::DMatch> FindCorrespondencesBetweenImages(
            const int image_id1, const int image_id2) const;
        ...
        const std::unordered_map<int, int> ImagePairs();
    ...
    private:
        ...
        // 场景图的结点
        std::unordered_map<int, typename SceneGraph::Image> images_;

        // 图像对之间有效的的匹配点的数量
        std::unordered_map<int, int> image_pairs_;
    };
